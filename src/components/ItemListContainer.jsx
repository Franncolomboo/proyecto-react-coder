        ...
        <main className="content-container-1">
            {!idCategory && (
                <section className="hero-content-1">
                    <div className="brand-titles-1">
                        <h1 className="brand-title-1">FC Solutions</h1>
                        <p className="signature-1">Francisco Colombo</p>
                    </div>
                    <div className="slogan-container-1">
                        <p className="slogan-1">Creamos <span className="span-principal-1">soluciones digitales escalables</span> diseñadas para potenciar <br /> <span className="span-marca-1">tu marca</span> y optimizar tus procesos</p>
                        <button className="button-home-1" onClick={scrollToContent}>
